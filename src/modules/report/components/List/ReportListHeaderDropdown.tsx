...
// import { loadUserDataFromLocalStorage } from "../../../auth/utils";

// export default function ReportListHeaderDropdown() {
//   const { user } = loadUserDataFromLocalStorage();
      ...
      {isDropdownOpen && (
        <div className="absolute right-0 mt-2 w-64 bg-white rounded-lg shadow-lg border border-gray-200 py-2 z-50">
          ...
          >
            ...
            <div className="flex flex-col">
              <span className="text-sm text-gray-700">Find Medicine</span>
              <span className="text-xs text-gray-500">
                Search & explore medicines
              </span>
            </div>
          </Link>
